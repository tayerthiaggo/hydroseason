...
map-free reports. `CatchmentReportPaths` preserves the five report artifact
paths (HTML, monthly CSV, hydrological-years CSV, wet-events CSV, and
low-spells CSV) and also exposes the manifest JSON path.
