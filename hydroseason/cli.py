...
def build_parser() -> argparse.ArgumentParser:
    ...
    fetch_p = sub.add_parser("fetch", help="Fetch monthly ERA5 variable from polygon")
    fetch_p.add_argument("--path", required=True)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "fetch":
        ...
        from .fetch import get_monthly_variable
